  ...
  return (
    <html lang='en'>
      <body className={cn('', dmSans.variable, instrumentSerif.variable)}>
        <div className='absolute inset-0 -z-10 h-screen w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem] bg-repeat'></div>
        <Cursor />
        <SplashScreen />
        <Navbar />
        {children}
