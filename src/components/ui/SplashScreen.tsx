  ...
  return (
    ...
    >
      ...
      <div className='loading-text-wrapper'>
        <p className='font-dmSans loading-text'>
          Smashing forms into existence, defying order and convention...
        </p>
      </div>
      <div className='left-0 absolute flex justify-center items-center py-4 w-full font-dmSans credits'>
        <p className='text-sm'>Designed and coded by Tazkiya Mujahid © 2024</p>
      </div>
    </div>
  );
}
